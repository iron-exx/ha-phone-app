...
/// polled every 10 s while the Kontakte or Ich tab is visible and the app is
/// in the foreground. Also sets the own presence (PUT).
class PresenceRepository extends ChangeNotifier {
  ...
  /// Called by the shell: true while Kontakte or Ich is on screen.
