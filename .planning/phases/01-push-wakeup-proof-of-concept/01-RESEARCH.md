...
| A5 | An active Apple Developer Program membership ($99/yr) and an active Google Play Console developer account ($25 one-time) already exist for this project | Environment Availability | If either is missing, Phase 1 cannot start on the affected platform until enrollment completes (Apple enrollment can take up to 24-48h); this is a hard, unverified prerequisite |
