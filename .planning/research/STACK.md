...
**Domain:** Native VoIP softphone companion app (iOS + Android) for a self-hosted Asterisk PBX, with a FastAPI push-relay backend
**Researched:** 2026-07-31
**Confidence:** HIGH for iOS/Android platform APIs and APNs/FCM protocols (official docs verified); MEDIUM for PJSIP integration tooling and specific version pins (community tooling changes often, verify build instructions against docs.pjsip.org at implementation time); MEDIUM for the "build from source vs. reuse" call, since it is genuinely a judgment call with tradeoffs on both sides.
...
pip install aioapns firebase-admin cryptography pyjwt
...
**If you want the fastest path to a Phase-1 "does push-wake-to-native-call-UI even work" prototype:**
...
---
*Stack research for: native VoIP softphone companion app (iOS + Android) for self-hosted Asterisk PBX*
*Researched: 2026-07-31*
